...
const NAV_BY_ROLE: Record<string, NavItem[]> = {
  estudiante: [
    ...
    {
      label: "Orientador Virtual",
      href: "/estudiante/orientador-virtual",
      icon: MessageSquare,
    },
  ...
  orientador: [
    ...
    { label: "Reconversion", href: "/orientador/reconversion", icon: FileText },
  ],
  apoderado: [
  ...
  admin_colegio: [
    ...
    { label: "Reconversion", href: "/admin/reconversion", icon: FileText },
