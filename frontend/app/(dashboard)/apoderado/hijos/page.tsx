  ...
  return (
    <RoleGuard allowedRoles={["apoderado"]}>
      <div className="space-y-6">
        <h1 className="text-2xl font-bold text-aura-ink">Mis Hijos</h1>
                ...
                {hijos.map((hijo) => (
                  <li key={hijo.student_id}>
                    <Link
                      ...
                      className="flex items-center gap-4 p-4 rounded-lg border border-aura-surface hover:border-aura-primary transition-colors group"
                    >
                      <div className="h-10 w-10 rounded-full bg-aura-primary/10 flex items-center justify-center shrink-0">
                        <User className="h-5 w-5 text-aura-primary" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-aura-ink group-hover:text-aura-primary truncate">
                          {hijo.student_name}
                        </p>
                      ...
                      <ChevronRight className="h-4 w-4 text-gray-400 group-hover:text-aura-primary shrink-0" />
                    </Link>
                  </li>
                ))}
              </ul>
