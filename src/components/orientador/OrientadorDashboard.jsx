      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-gray-500 text-sm">Estudiantes Asignados</p>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-gray-500 text-sm">Horas (últimos 30d)</p>
              <p className="text-3xl font-bold text-gray-900">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              disabled={refreshing}
              className="px-3 py-1 bg-gray-100 text-white rounded-lg hover:bg-gray-200 transition-colors text-sm disabled:opacity-50"
            >
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto">
              {students.map((student) => (
                <Link
                  key={student.id}
                  to={`/orientador/estudiante/${student.student_id}`}
                  className="block bg-white border border-gray-200 shadow-sm rounded-lg p-4 hover:bg-gray-100 transition-all"
                >
        ...
        >
          ...
          <div className="space-y-3">
            <Link
              ...
              className="flex items-center gap-4 bg-white border border-gray-200 shadow-sm rounded-lg p-4 hover:bg-gray-100 transition-all"
            >
              <div className="p-3 bg-blue-500/20 rounded-lg">
                <Calendar className="text-blue-400" size={24} />
              </div>
              <div>
                <h3 className="text-gray-900 font-semibold">Mi Disponibilidad</h3>
            ...
            >
              ...
              <div>
                <h3 className="text-gray-900 font-semibold">Mis Sesiones</h3>
                <p className="text-gray-500 text-sm">
            ...
            >
              ...
              <div>
                <h3 className="text-gray-900 font-semibold">Calendario</h3>
                <p className="text-gray-500 text-sm">
          ...
          <div className="mt-6 p-4 bg-white/5 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              <span className="text-gray-500 text-sm">Carga de Trabajo</span>
