      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-indigo-50 border border-indigo-200 rounded-full px-4 py-2 mb-4">
            ...
            <span className="text-indigo-700 text-sm font-medium">{tx(t.about.badge, lang)}</span>
          </div>
          ...
          <p
            ...
            dangerouslySetInnerHTML={{ __html: tx(t.about.subtitle, lang) }}
          />
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-poppins font-bold text-vocari-dark mb-3">{tx(t.about.card1t, lang)}</h3>
            <p className="text-gray-600 leading-relaxed">
              {tx(t.about.card1d, lang)}
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-poppins font-bold text-vocari-dark mb-3">{tx(t.about.card2t, lang)}</h3>
            <p className="text-gray-600 leading-relaxed">
              {tx(t.about.card2d, lang)}
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-poppins font-bold text-vocari-dark mb-3">{tx(t.about.card3t, lang)}</h3>
            <p className="text-gray-600 leading-relaxed">
              {tx(t.about.card3d, lang)}
            </p>
          </motion.div>
        </div>
        ...
        >
          <p className="text-amber-800 font-medium mb-2">{tx(t.about.noteTitle, lang)}</p>
          <p className="text-amber-700 text-sm leading-relaxed">
            {tx(t.about.noteBody, lang)}
          </p>
          <a
