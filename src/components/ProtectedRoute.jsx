    ...
    return (
      <div className="min-h-screen bg-vocari-bg flex items-center justify-center p-4">
        <motion.div
          ...
          className="max-w-md w-full bg-white border border-gray-200 shadow-lg rounded-2xl p-8 text-center"
        >
          ...
          <button
            ...
            className="w-full px-6 py-3 bg-vocari-primary text-white rounded-lg hover:bg-vocari-primary/80 transition-colors"
          >
            Volver al Inicio
          </button>
